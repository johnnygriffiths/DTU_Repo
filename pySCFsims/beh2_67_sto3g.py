...
mol = gto.M(
    atom = 'Be 0 0 0; H 0 0 1.330; H 0 0 -1.330',
    basis = 'sto-3g',
...
# CASCI: 4 electrons in 4 orbitals
# select active space (Be has 4e), then selects certain number orbitals, some ooccu, some virtual
...
solver = fci.addons.fix_spin_(solver, ss=0.0, shift=10.0)
